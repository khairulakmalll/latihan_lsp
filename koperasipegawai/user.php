        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data User Account</h1>
                    ...
                    <div class="card mb-4">
                        ...
                        // Ambil data Petugas
                        $petugasQuery = mysqli_query($koneksi, "SELECT * FROM petugas WHERE level = 1");

                        // Ambil data Manager
                        $managerQuery = mysqli_query($koneksi, "SELECT * FROM manager WHERE level = 2");
                        ?>
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="card mb-4 w-100 h-100">
                                    <div class="card-header bg-primary text-white">
                                        <i class="fas fa-users"></i> Daftar User - Petugas
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($petugasQuery)): ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['username']; ?></td>
                                                        <td>
                                                            <a href="hapus_user.php?tipe=petugas&id=<?= $row['id_user']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            </tbody>
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="card mb-4 w-100 h-100">
                                    <div class="card-header bg-success text-white">
                                        <i class="fas fa-user-tie"></i> Daftar User - Manager
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($managerQuery)): ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['username']; ?></td>
                                                        <td>
                                                            <a href="hapus_user.php?tipe=manager&id=<?= $row['id_user']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            </tbody>
