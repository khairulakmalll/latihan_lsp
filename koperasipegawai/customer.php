                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <?php
                            include 'koneksi.php';
                            $data = $koneksi->query("SELECT * FROM customer");
                            ?>
                                    ...
                                    <tbody>
                                        <?php while ($row = $data->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td><?= $row['email'] ?></td>
                                                <td>
                                                    <a href="edit_customer.php?id=<?= $row['id_customer'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                                    <a href="hapus_customer.php?id=<?= $row['id_customer'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus?')">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
